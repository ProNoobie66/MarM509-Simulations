...
p.seedPart(size=0.25, deviationFactor=0.1, minSizeFactor=0.1, constraint=FINER)
...
if 'Set-Carbides' in p.sets:
    ...
    if edgesToSeed:
        ...
        p.seedEdgeBySize(edges=edgesToSeed, size=0.1, deviationFactor=0.1, constraint=FINER)
